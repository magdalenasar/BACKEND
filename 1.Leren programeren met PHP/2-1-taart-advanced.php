...
$aantal_stukken_1 = intdiv($aantal_deelnemers, $aantal_taarten);     //gehele deling: intigerdivision()
...
printf( $bericht1, $t1 , $aantal_stukken_1 );      // typecasting: (int) => conversie naar int

if ( $t2 != 0 )  // ALS dat(taart2) verschillend is van 0 alleen dan gaan de tweede bericht tonen
{
